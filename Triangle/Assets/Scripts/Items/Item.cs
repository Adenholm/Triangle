...
public class Item : MonoBehaviour
{
  ...
  public enum ItemType
    ...
    public Element GetElement()
    {
        ...
        {
            default:
            case ItemType.Wood: return Element.NONE;
            case ItemType.Iron: return Element.NONE;
            case ItemType.Fur: return Element.NONE;
            case ItemType.Crystal: return Element.NONE;
            case ItemType.Sword: return Element.NONE;
            case ItemType.Bow: return Element.NONE;
            case ItemType.Armour: return Element.NONE;
            case ItemType.Firemeat: return Element.FIRE;
            case ItemType.Watermeat: return Element.WATER;
            case ItemType.Airmeat: return Element.WIND;
            case ItemType.Plantmeat: return Element.PLANT;
        }
    }
